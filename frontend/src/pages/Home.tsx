  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <div className="d-none d-md-block">
          ...
          <div className="container-fluid p-0">
            <div className="row align-items-center">
              <div className="col-sm-6">
                <h1 className="m-0 font-weight-bold text-dark" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
                  Welcome back, {displayName}!
                </h1>
                <p className="text-muted mb-0" style={{ fontSize: '14px' }}>Role: <span className="badge badge-secondary">{userRole}</span></p>
              </div>
        ...
        {/* Quick Actions Card */}
        <div className="card card-primary card-outline shadow-sm mt-4">
          <div className="card-header">
            <h3 className="card-title font-weight-bold text-dark">
              <i className="fas fa-th-large mr-2 text-primary"></i> Application Quick Links
            </h3>
          </div>
      ...
      <div className="d-md-none">
        ...
        <h6 className="font-weight-bold mb-2 text-muted px-2">QUICK LINKS</h6>
        <div className="card shadow-sm mb-4" style={{ borderRadius: '12px' }}>
          <div className="card-body p-3">
            <div className="row">
              {activeMenuItems.map(item => (
